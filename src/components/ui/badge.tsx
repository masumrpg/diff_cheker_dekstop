	...
	"inline-flex items-center rounded-[8px] border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
	{
		variants: {
			variant: {
				...
				success: "border-transparent bg-[hsl(var(--neon-green)/0.15)] text-[hsl(var(--neon-green))] border-[hsl(var(--neon-green)/0.3)]",
				info: "border-transparent bg-[hsl(var(--neon-cyan)/0.15)] text-[hsl(var(--neon-cyan))] border-[hsl(var(--neon-cyan)/0.3)]",
			},
		},
		defaultVariants: {
			variant: "default",
